...
class mergeSpaceToSideHelper {
    public check(sideCheck, selectionShape: Shape, shape: Shape, mergeSpace: number): boolean {
        switch (sideCheck) {
            case side.Left:
...
export default new mergeSpaceToSideHelper()